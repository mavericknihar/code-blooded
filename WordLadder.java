...
public class WordLadder {
    ...
    public static void main(String[] args) throws Exception {
        List<String> dic = Arrays.asList("kid", "tag", "pup", "ail", "tun", "woo", "erg", "luz", "brr", "gay", "sip", "kay",
        ...
        new WordLadder().findLadders("cet", "ism", dic);
    }
        ...
        while (!queue.isEmpty()) {
            ...
            for (int j = 0, ln = childSb.length(); j < ln; j++) {
                for (int i = 0, l = CONST.length(); i < l; i++) {
                    ...
                    childSb.setCharAt(j, CONST.charAt(i));
    ...
    private void addChild(String parent, String child) {
        Set<String> children = graph.getOrDefault(parent, new HashSet<>());
        children.add(child);
